...
function SignUp() {
    ...
    return (
        <div className='flex h-screen w-full items-center justify-center'>
            <form onSubmit={handleSubmit(onSubmit)} className='w-96 border border-white px-6 py-2 rounded-md space-y-3'>
                ...
                {errors.fullname && <span className='text-rose-500 text-sm font-semibold'>This field is required</span>}
                ...
                {errors.email && <span className='text-rose-500 text-sm font-semibold'>This field is required</span>}
                ...
                {errors.password && <span className='text-rose-500 text-sm font-semibold'>This field is required</span>}
                ...
                {errors.confirmPassword && <span className='text-rose-500 text-sm font-semibold'>{errors.confirmPassword.message}</span>}
